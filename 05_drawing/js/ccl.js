    ...
    function() {
        ...
        d3.json(file, function(error, data) {
            ...
            color.domain(d3.keys(data[0]).filter(function(key) {
                return (key == 'mails' || key == 'xreference' || key == 'xreferencepercent');
            }));

            var sets = color.domain().map(function(attr) {
                return {
                    attr: attr,
            ...
            y.domain([
                d3.min(sets, function(d) {
                    return d3.min(d.values, function(d) {
                        return d.value;
                    });
                }),
                d3.max(sets, function(d) {
        ...
        // Fourth graph : Volume of threads launched
        ...
        var svg4 = d3.select("#volumeOfThreadsLaunched").append("svg")
            .attr("width", width + margin.left + margin.right)
            .attr("height", height + margin.top + margin.bottom)
            .append("g")
            .attr("transform", "translate(" + margin.left + "," + margin.top + ")");
        ...
        var svg5 = d3.select("#volumeOfThreadsLaunchedByMonths").append("svg")
            .attr("width", width + margin.left + margin.right)
            .attr("height", height + margin.top + margin.bottom)
            .append("g")
            .attr("transform", "translate(" + margin.left + "," + margin.top + ")");
